...
Route::get('/OrderDiterima', [App\Http\Controllers\SuperAdminController::class, 'orderDiterimaTable'])->middleware('hak.akses:superAdmin,adminPemesanan'); //lihat Table Pemesanan
