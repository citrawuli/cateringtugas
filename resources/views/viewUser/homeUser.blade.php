...
<div class="product-in-stock-wrapp">
    <div class="container">
        ...
        <a href="{{url('/catalogproduct')}}" type="button" class="btn btn-default" style="background-color: rgb(0, 128, 0); color:whitesmoke">Kembali Berbelanja</a><br><br>
        <h4>PROFIL</h4>
        ...
        <a href="{{url('/ketentuan')}}">
            ...
            <span class="blog-title">Lihat Ketentuan Pemesanan dan Pembayaran</span>
        </a>
        <br><br><br><br>
    </div>
</div>
