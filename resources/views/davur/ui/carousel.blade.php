                                ...
                                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img class="d-block w-100" src="{{ asset('davur/images/big/img1.jpg') }}" alt="First slide">
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="{{ asset('davur/images/big/img2.jpg') }}" alt="Second slide">
                                        </div>
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="{{ asset('davur/images/big/img3.jpg') }}" alt="Third slide">
                                        </div>
                            ...
                            <h4 class="card-intro-title">With Captions</h4>
                                <div class="bootstrap-carousel">
                                    <div class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img class="d-block w-100" src="{{ asset('davur/images/big/img2.jpg') }}" alt="First slide">
                                            ...
                                            <div class="carousel-item">
                                                <img class="d-block w-100" src="{{ asset('davur/images/big/img3.jpg') }}" alt="Second slide">
                                                <div class="carousel-caption d-none d-md-block">
                                            ...
                                            <div class="carousel-item">
                                                <img class="d-block w-100" src="{{ asset('davur/images/big/img4.jpg') }}" alt="Third slide">
                                                <div class="carousel-caption d-none d-md-block">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="bootstrap-carousel">
                                    <div class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img class="d-block w-100" src="{{ asset('davur/images/big/img3.jpg') }}" alt="First slide">
                                            </div>
                                            <div class="carousel-item">
                                                <img class="d-block w-100" src="{{ asset('davur/images/big/img4.jpg') }}" alt="Second slide">
                                            </div>
                                            <div class="carousel-item">
                                                <img class="d-block w-100" src="{{ asset('davur/images/big/img5.jpg') }}" alt="Third slide">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="bootstrap-carousel">
                                    <div id="carouselExampleIndicators2" class="carousel slide" data-ride="carousel">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img class="d-block w-100" src="{{ asset('davur/images/big/img4.jpg') }}" alt="First slide">
                                            </div>
                                            <div class="carousel-item">
                                                <img class="d-block w-100" src="{{ asset('davur/images/big/img5.jpg') }}" alt="Second slide">
                                            </div>
                                            <div class="carousel-item">
                                                <img class="d-block w-100" src="{{ asset('davur/images/big/img6.jpg') }}" alt="Third slide">
                                            </div>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="bootstrap-carousel">
                                    <div data-ride="carousel" class="carousel slide" id="carouselExampleCaptions">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img class="d-block w-100" src="{{ asset('davur/images/big/img5.jpg') }}" alt="">
                                                <div class="carousel-caption d-none d-md-block">
                                                    <h5>First slide label</h5>
                                                    <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
                                                </div>
                                            ...
                                            <div class="carousel-item">
                                                <img alt="" class="d-block w-100" src="{{ asset('davur/images/big/img6.jpg') }}">
                                                <div class="carousel-caption d-none d-md-block">
                                                    <h5>Second slide label</h5>
                                            ...
                                            <div class="carousel-item">
                                                <img alt="" class="d-block w-100" src="{{ asset('davur/images/big/img7.jpg') }}">
                                                <div class="carousel-caption d-none d-md-block">
                                                    <h5>Third slide label</h5>
