			...
			<div class="container-fluid">
                ...
                <div class="row">
									...
									<div class="row align-items-center">
										...
										<div class="col-xl-9 col-lg-10 col-xxl-8 col-sm-9 col-md-9">
											<div class="d-flex align-items-center mb-3">
												<p class="mb-0 fs-14 mr-2 col-4 col-xxl-5 px-0">Immunities (24%)</p>
											...
											<div class="d-flex align-items-center  mb-3">
												<p class="mb-0 fs-14 mr-2 col-4 col-xxl-5 px-0">Heart Beat (41%)</p>
												<div class="progress mb-0" style="height:8px; width:100%;">
											...
											<div class="d-flex align-items-center">
												<p class="mb-0 fs-14 mr-2 col-4 col-xxl-5 px-0">Weigth (15%)</p>
												<div class="progress mb-0" style="height:8px; width:100%;">
													<div class="progress-bar bg-dark progress-animated" style="width:30%; height:8px;" role="progressbar">
														<span class="sr-only">60% Complete</span>
													</div>
												</div>
												<span class="pull-right ml-auto col-1 col-xxl-2 px-0 text-right">07</span>
											</div>
										</div>	
									</div>	
								</div>
							...
							<div class="card-body revenue-chart px-3">
									<div class="d-flex align-items-end pr-3 pull-right revenue-chart-bar">
										<div class="d-flex align-items-end mr-4">
											<img src="{{ asset('davur/images/svg/ic_stat2.svg') }}" height="22" width="22" class="mr-2 mb-1" alt=""/>
											<div>
										...
										<div class="d-flex align-items-end">
											<img src="{{ asset('davur/images/svg/ic_stat1.svg') }}" height="22" width="22" class="mr-2 mb-1" alt=""/>
											<div>
					...
					<div class="col-xl-3 col-xxl-3 col-lg-4 col-md-12">
						<div class="card bg-secondary" style="background-image:url(davur/images/bg-icon.png); background-repeat:no-repeat; background-position:top right;">
