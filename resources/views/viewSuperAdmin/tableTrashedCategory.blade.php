    ...
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Tong Sampah Kategori</a></li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-6">
            <div class="card text-white bg-primary">
                ...
                <div class="card-body mb-0">
                    ...
                    <a href="{!! url('/RestoreAllCategory'); !!}" class="btn light btn-danger">Kembalikan Semua</a>
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header text-white bg-danger">
                    <h4 class="card-title">Daftar Kategori yang Dibuang</h4>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <a href="{{ url( '/RestoreCategory/' . $mod->id ) }}" class="btn btn-warning shadow btn-xs sharp mr-1" data-toggle="tooltip" data-placement="top" title="Restore Category" id="editt"><i class="fa fa-repeat"></i></a>
