...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Halaman SUPER ADMIN</div>
			...
			<div class="container-fluid">
				<div class="form-head d-flex mb-3 align-items-start">
					<div class="mr-auto d-none d-lg-block">
						...
						<p class="mb-0">Selamat datang di Laman Super Admin!</p>
					</div>
							...
							<div class="card-body p-4">
								<div class="media ai-icon">
									...
									<div class="media-body">
										<h3 class="mb-0 text-black"><span class="counter ml-0">{{$totalproduk}}</span></h3>
								...
								<div class="media ai-icon">
									...
									<div class="dropdown mt-3 mt-sm-0">
										...
										<div class="dropdown-menu">
											<a class="dropdown-item today_or" id="today_or" >Hari ini</a>
											<a class="dropdown-item month_or" id="month_or">Bulan ini</a>
											<a class="dropdown-item year_or" id="year_or">Tahun ini</a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="widget-stat card">
							<div class="card-body p-4">
								<div class="media ai-icon">
									...
									<div class="media-body">
										<h3 class="mb-0 text-black"><span class="counter ml-0">{{$totalusers}}</span></h3>
										<p class="mb-0">Total Customer Website</p>
										{{-- <small>4% (30 days)</small> --}}
									</div>
								</div>
							</div>
					...
					<div class="col-xl-6 col-xxl-6 col-lg-12 col-md-12">
						<div class="card">
							<div class="card-header border-0 pb-0 d-sm-flex d-block">
								<div>
									<h4 class="card-title mb-1">Ringkasan Pemesanan</h4>
									<small class="mb-0">Order masuk = menunggu konfirmasi</small>
								</div>
							...
							<div class="card-body orders-summary">
								<div class="d-flex order-manage p-3 align-items-center mb-4">
									<a href="javascript:void(0);" class="btn fs-22 py-1 btn-success px-4 mr-3">{{$waiting}}</a>
									<h4 class="mb-0">Order Masuk<i class="fa fa-circle text-success ml-1 fs-15"></i></h4>
									<a href="{{url('PemesananTable')}}" class="ml-auto text-primary font-w500">Lihat order<i class="ti-angle-right ml-1"></i></a>
									
								</div>
								<div class="row">
									<div class="col-sm-3 mb-4">
										<div class="border px-3 py-3 rounded-xl">
											<h2 class="fs-32 font-w600 counter">{{$notyet}}</h2>
											<p class="fs-16 mb-0">Belum Diproses</p>
										</div>
									</div>
									<div class="col-sm-3 mb-4">
										<div class="border px-3 py-3 rounded-xl">
											<h2 class="fs-32 font-w600 counter">{{$still}}</h2>
											<p class="fs-16 mb-0">Sedang Diproses</p>
										</div>
									</div>
									<div class="col-sm-3 mb-4">
										<div class="border px-3 py-3 rounded-xl">
											<h2 class="fs-32 font-w600 counter">{{$delivered}}</h2>
											<p class="fs-16 mb-0">Dikirim</p>
										</div>
									</div>
									<div class="col-sm-3 mb-4">
										<div class="border px-3 py-3 rounded-xl">
											<h2 class="fs-32 font-w600 counter">{{$finished}}</h2>
						...
						<div class="card">
							...
							<div class="card-body orders-summary">
								...
								<div class="row">
									...
									<div class="col-sm-3 mb-4">
										<div class="border px-3 py-3 rounded-xl">
											<h2 class="fs-32 font-w600 counter">{{$penangguhan}}</h2>
											<small>@currency($JMLpenangguhan)</small>
											<p class="fs-16 mb-0">Ditangguhkan</p>
										</div>
									</div>
									<div class="col-sm-3 mb-4">
										<div class="border px-3 py-3 rounded-xl">
...
$(document).ready(function () {
    ...
    $('#today_or').on('click', function () {
        var a = "{{URL('/dashboardFilter')}}";
        $.ajax({
            url: a,
            type:'GET',
			data: {'filter': 'today_or'},
			cache:false,
	...
	$('#month_or').on('click', function () {
        var a = "{{URL('/dashboardFilter')}}";
        $.ajax({
            url: a,
            type:'GET',
			data: {'filter': 'month_or'},
			cache:false,
            success:function(response){ 
				$('#totalpemesanan').html(response); // use it to fill your result
            },
